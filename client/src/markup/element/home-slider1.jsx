...
const slides = [
    {
        title: '',
        description: 'Your #1 Resource For Texas Tax Sales Training, Mentoring and Services',
        btnLearn: "-- Learn More --",
        finan: "Resource",
        dox: "Group",
    ...
    },
    {
        ...
        description: 'We Make it easier for you to attain success with Texas Tax Sales',
        btnLearn: "-- Learn More --",
        finan: "Resource",
        dox: "Group",
        btnService: "-- Our Services --",
        image: require('./../../assets/images/main-slider/11.jpg'),
    },
    // {
